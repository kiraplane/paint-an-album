  ...
  return [
    {
      ...
      items: [
        {
          title: t('wiki.items.howToPlay'),
          href: Routes.HowToPlay,
          external: false,
        },
        {
          title: t('wiki.items.albumSearch'),
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: t('guides.items.coverIdeas'),
          href: Routes.CoverIdeasGuide,
          external: false,
        },
        {
          title: t('guides.items.cleanPainting'),
